...
export default function Footer() {
    return (
        <>
            {/* Mobile footer */}
            <footer className="sm:hidden lg:hidden flex flex-col gap-4 p-4 font-instrument-serif">
                <div className="flex flex-col">
                    <h3 className="text-black text-2xl">Did you have something in mind?</h3>

                    <Link href="/contact" className="flex flex-row gap-2">
                        <h1 className="text-secondary text-8xl leading-[85%]">Let's talk!</h1>
                        <Image src={arrowLink} alt="arrow link" className="w-13 h-13 relative left-[-15px] top-[-10px]"/>
                    </Link>

                    <div className="flex gap-4 font-instrument-sans mt-2">
                ...
                <div className="flex flex-row justify-between">
                    <div className="flex flex-col gap-1">
                        ...
                        <Link href="/" className="text-xl text-secondary animated-underline w-fit">
                            Home
                        </Link>
                        <Link href="/projects" className="text-xl text-secondary animated-underline w-fit">
                            Projects
                        </Link>
                        <Link href="/about" className="text-xl text-secondary animated-underline w-fit">
                            About
                        </Link>
                        <Link href="/contact" className="text-xl text-secondary animated-underline w-fit">
                            Contact
                        </Link>
                    </div>
            ...
            {/* Tablet footer */}
            <footer className="hidden lg:hidden sm:flex flex-row justify-between p-4 font-instrument-serif">
                <div className="flex flex-col">
                    <h3 className="text-black text-2xl">Did you have something in mind?</h3>

                    <Link href="/contact" className="flex flex-row gap-2">
                        <h1 className="text-secondary text-[10rem] leading-[85%]">Let's talk!</h1>
                        <Image src={arrowLink} alt="arrow link" className="w-13 h-13 relative left-[-15px] top-[-10px]"/>
                    </Link>

                    <div className="flex gap-4 font-instrument-sans">
                        <Link href="https://github.com/BleuSkell" target="_blank" className="flex items-center gap-2">
            ...
            {/* Desktop footer */}
            <footer className="hidden lg:flex flex-row justify-between p-12 font-instrument-serif">
                <div className="flex flex-col">
